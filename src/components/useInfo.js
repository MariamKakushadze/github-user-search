...
export default function UserInfo({ theme }) {
  return (
    <div
      className="userInfo"
    ...
    >
      <div className="profile">
        <img className="prPhoto" src={ProfilePic} alt=""></img>
        <div className="briefInfo">
          <p className="userName" style={{ color: theme ? "#2B3442" : "#FFF" }}>
            The Octocat
          </p>
          <p className="userId">@octocat</p>
          <p
      ...
      <footer style={{ color: theme ? "#4B6A9B" : "#FFF" }}>
